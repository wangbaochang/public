...
public class WeixinPlaceOrderResData implements Serializable{
	...
	//公众账号ID	是	String(32)	wx8888888888888888	调用接口提交的公众账号ID
	private String appid;
	//商户号		是	String(32)	1900000109	调用接口提交的商户号
	private String mch_id;
	//设备号	否	String(32)	013467007045764	自定义参数，可以为请求支付的终端设备号等
	private String device_info;	
	//随机字符串		是	String(32)	5K8264ILTKCH16CQ2502SI8ZNMTM67VS	微信返回的随机字符串
	private String nonce_str;
	//签名	是	String(32)	C380BEC2BFD727A4B6845133519F3AD6	微信返回的签名值，详见签名算法
	private String sign;	
	//业务结果	是	String(16)	SUCCESS	SUCCESS/FAIL
	private String result_code;	
	//错误代码	否	String(32)	SYSTEMERROR	详细参见下文错误列表
	private String err_code;	
	//错误代码描述	否	String(128)	系统错误	错误信息描述
	private String err_code_des;	
	
	//以下字段在return_code 和result_code都为SUCCESS的时候有返回
	//交易类型	是	String(16)	JSAPI	交易类型，取值为：JSAPI，NATIVE，APP等，说明详见参数规定
	private String trade_type;	
	//预支付交易会话标识	是	String(64)	wx201410272009395522657a690389285100	微信生成的预支付回话标识，用于后续接口调用中使用，该值有效期为2小时

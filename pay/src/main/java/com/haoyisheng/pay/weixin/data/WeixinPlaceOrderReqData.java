...
public class WeixinPlaceOrderReqData implements Serializable {
		...
		//公众账号ID	null 是	String(32)	wxd678efh567hg6787	微信支付分配的公众账号ID（企业号corpid即为此appId）
		...
		private String sign	;
		//签名类型		否	String(32)	HMAC-SHA256	签名类型，默认为MD5，支持HMAC-SHA256和MD5。
		private String sign_type;
		//商品描述	是	String(128)	腾讯充值中心-QQ会员充值   商品简单描述，该字段请按照规范传递，具体请见参数规定
		private String body;
		//商品详情		否	String(6000)	 	单品优惠字段(暂未上线)
		private String detail;
		//附加数据		否	String(127)	深圳分店	附加数据，在查询API和支付通知中原样返回，可作为自定义参数使用。
		private String attach;
		//商户订单号	是	String(32)	20150806125346	商户系统内部订单号，要求32个字符内、且在同一个商户号下唯一。 详见商户订单号
		private String out_trade_no;
		//标价币种		否	String(16)	CNY	符合ISO 4217标准的三位字母代码，默认人民币：CNY，详细列表请参见货币类型
		private String fee_type;
		//标价金额		是	Int	88	订单总金额，单位为分，详见支付金额
		...
		//交易结束时间		否	String(14)	20091227091010	订单失效时间，格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。其他详见时间规则 注意：最短失效时间间隔必须大于5分钟

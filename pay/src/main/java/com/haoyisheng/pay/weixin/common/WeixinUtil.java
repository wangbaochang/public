package com.haoyisheng.pay.weixin.common;
...
public  class WeixinUtil {
    ...
    public static String getSign(Object o,String key) throws IllegalAccessException {
        ...
        for (Field f : fields) {
            ...
            if (f.get(o) != null && f.get(o) != "" && !Modifier.isStatic(f.getModifiers())) {
    ...
    public static String getSignFromResponseString(String responseString,String key) throws IOException, SAXException, ParserConfigurationException {
        Map<String,Object> map = BeanUtil.getMapFromXML(responseString);
